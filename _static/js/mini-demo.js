var m20 = (function() {
  ...
  function stim_img(str, flip=false) {
    if (flip) {
      // return `<img class="flip" src="../_static/stimuli/m20/${str}.png" />`
      return `<img class="flip" src="../_static/stimuli/${str}.png" />`
    } else {
      // return `<img src="../_static/stimuli/m20/${str}.png" />`
      return `<img src="../_static/stimuli/${str}.png" />`
    }
  } 
  ...
  // function to generate madlib stimulus
  function stim_madlib(arr, flip=false) {
    return stim_img(icons2fn(arr), flip) + 
      `<div id="caption" class="iconic">${arr[0]} %blank%</div>`
  }
  ...
  function block2() { // 2 trials
    ...
    DATA.block2.push({
      type: jsPsychMadlib,
      stimulus: stim_madlib(icons, flip),
